function init() {
  ...
  // when the document is modified, add a "*" to the wife and enable the "Save" button
  ...
  function nodeDoubleClick(e, obj) {
    ...
    if (clicked !== null) {
      ...
      var newemp = { key: getNextKey(), name: "(new person)", wife: "", parent: thisemp.key };
      ...
      $(go.Panel, "Horizontal",
        ...
        $(go.Panel, "Table",
          ...
          $(go.TextBlock, textStyle(),
            ...
            new go.Binding("text", "wife").makeTwoWay()),
          $(go.TextBlock, textStyle(),
            { row: 2, column: 0 },
          ...
          $(go.TextBlock, textStyle(),  // the info
            {
        ...
        $(go.TextBlock, "Vacate Position"),
        {
          click: function(e, obj) {
            ...
            if (node !== null) {
              ...
              // update the key, name, and info
              myDiagram.model.setKeyForNodeData(thisemp, getNextKey());
              myDiagram.model.setDataProperty(thisemp, "name", "(Vacant)");
              myDiagram.model.setDataProperty(thisemp, "info", "");
...
function readAsText()
{
    ...
    {
        var result=document.getElementById("mySavedModel");
...
function saveastext(){
  var fso,tf;
  	...
  	tf = fso.CreateTextFile("C:\\Users\\Administrator\\Desktop\\ca\\test.txt",true,true);
